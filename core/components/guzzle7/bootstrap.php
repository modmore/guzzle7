...
if (class_exists(\GuzzleHttp\Client::class) && class_exists(\GuzzleHttp\ClientInterface::class)) {
    return;
}
...
$loaded = class_exists(\GuzzleHttp\Client::class) && class_exists(\GuzzleHttp\ClientInterface::class);
